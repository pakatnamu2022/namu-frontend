...
const controlUnitsSchemaBase = z.object({
...
export const controlUnitsSchemaCreate = controlUnitsSchemaBase
  .refine(
    (data) => {
...
export const controlUnitsSchemaUpdate = controlUnitsSchemaBase.partial();

export type ControlUnitsSchema = z.infer<typeof controlUnitsSchemaCreate>;
