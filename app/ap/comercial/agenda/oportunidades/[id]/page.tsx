...
import { OpportunityActionTimeline } from "@/src/features/ap/comercial/oportunidades/components/OpportunityActionTimeline";
...
import { OpportunityActionResource } from "@/src/features/ap/comercial/oportunidades/lib/opportunityAction.interface";
      ...
      <HeaderTableWrapper>
        ...
        {!isClosedOpportunity && (
          <div className="flex justify-end items-center gap-2 w-full">
            ...
            <Link href={`${ABSOLUTE_ROUTE}/actualizar/${opportunity.id}`}>
