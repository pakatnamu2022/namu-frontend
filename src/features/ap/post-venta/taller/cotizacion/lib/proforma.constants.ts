...
// AGRUPACION DE ESTADOS PARA EL FILTRO "Abiertas / Facturadas / Segmentadas"
export const ORDER_QUOTATION_STATUS_GROUP = {
  ABIERTAS: "abiertas",
...
export type OrderQuotationStatusGroup =
  (typeof ORDER_QUOTATION_STATUS_GROUP)[keyof typeof ORDER_QUOTATION_STATUS_GROUP];

export const ORDER_QUOTATION_STATUS_GROUP_IDS: Record<
  OrderQuotationStatusGroup,
  number[]
> = {
  [ORDER_QUOTATION_STATUS_GROUP.ABIERTAS]: [
    STATUS_ORDER_QUOTE.APERTURADO,
    STATUS_ORDER_QUOTE.APROBADO,
    STATUS_ORDER_QUOTE.FACTURAR,
  ],
  [ORDER_QUOTATION_STATUS_GROUP.FACTURADAS]: [STATUS_ORDER_QUOTE.FACTURADO],
  [ORDER_QUOTATION_STATUS_GROUP.SEGMENTADAS]: [
    STATUS_ORDER_QUOTE.SEGMENTADO,
    STATUS_ORDER_QUOTE.DESCARTADO,
  ],
  [ORDER_QUOTATION_STATUS_GROUP.DESCARTADAS]: [STATUS_ORDER_QUOTE.DESCARTADO],
};
