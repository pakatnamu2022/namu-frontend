...
export default function ParameterInfo({ parameter, info = false }: Props) {
  ...
  return (
    <div className="border rounded-md mt-2 text-sm bg-muted overflow-hidden">
      ...
      <div className="bg-background p-4 h-full">
        ...
        {!info && (
          <div className="border-b mb-3 border-muted pb-3">
        ...
        <div className="">
          ...
          <Table className="lg:w-2/3 w-full text-sm !border-none">
            ...
            <TableBody>
              {parameter.details.map((range, index) => (
                  ...
                  <TableCell className="border pl-2 pr-10 py-2">
                    <div
                      className={cn(
                        ...
                        getScales(parameter.details.length)[index]
                      )}
                    >
                      {range.label}
                    </div>
