...
export default function BlacklistApplicantsPage() {
  ...
  const { data, isLoading, refetch } = useApplicants({
    ...
    search,
    per_page,
    tipo_trabajador_id: [APPLICANT_TYPE.RECHAZADO, APPLICANT_TYPE.LISTA_NEGRA],
  });
  ...
  if (!checkRouteExists(BLACKLIST_ROUTE)) notFound();
    ...
    <div className="space-y-4">
      <HeaderTableWrapper>
        <TitleComponent
          ...
          subtitle="Postulantes rechazados o en lista negra. Solo los rechazados pueden repostularse; lista negra no es recontratable."
