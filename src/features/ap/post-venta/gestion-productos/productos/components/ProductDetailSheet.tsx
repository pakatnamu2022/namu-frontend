...
import { findProductById } from "../lib/product.actions";
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  {product.category && (
                    <div>
                      ...
                      <p className="font-medium">{product.category.description}</p>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        {product.brand.logo_min && (
                          <img
                            src={`${import.meta.env.VITE_API_BASE_URL}/storage/${product.brand.logo_min}`}
                    ...
                    {product.warehouse_stocks.map((ws) => (
                      ...
                      >
                        ...
                        <div className="grid grid-cols-3 gap-2 text-xs">
                          <div>
                            <p className="text-muted-foreground">En Tránsito</p>
                            <p className="font-medium">
