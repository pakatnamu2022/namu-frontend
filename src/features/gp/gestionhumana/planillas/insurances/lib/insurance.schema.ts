...
export const insuranceSchema = z.object({
  ...
  business_partner_id: requiredStringId("El socio de negocio es requerido"),
  family_group_number: z
    .string()
    .min(1, "El número de grupo familiar es requerido"),
  ...
  rate_without_tax: z.coerce
    .number()
    .min(0, "La tasa sin impuesto debe ser mayor o igual a 0"),
  tax: z.coerce.number().min(0, "El impuesto debe ser mayor o igual a 0"),
  rate_with_tax: z.coerce
    .number()
    .min(0, "La tasa con impuesto debe ser mayor o igual a 0"),
