...
export default function PayrollHistoricalBonusImportDialog({
  open,
  onClose,
  companyId,
  companyName,
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Sube el Excel (.xlsx, .xls) con el histórico de bono/comisión
              (bono de conductores) — mismo formato que la plantilla
              descargable. Filas en cero se omiten sin marcarse como error.
              Los meses que no existan se crean automáticamente.
            </p>
            <FormField
