...
const MILLA_BASE =
  import.meta.env.VITE_MILLA_BASE ?? "https://api.grupopakatnamu.com/storage/app/";
const MILLA_GP_BASEPATH =
  import.meta.env.VITE_MILLA_GP_BASEPATH ?? "https://api.grupopakatnamu.com";
