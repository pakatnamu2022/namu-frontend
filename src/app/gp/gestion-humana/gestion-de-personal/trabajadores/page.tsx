...
import WorkerOptions from "@/features/gp/gestionhumana/gestion-de-personal/trabajadores/components/WorkerOptions";
import WorkerTable from "@/features/gp/gestionhumana/gestion-de-personal/trabajadores/components/WorkerTable";
...
export default function WorkersPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      errorToast(ERROR_MESSAGE(MODEL, "delete"), error.response?.data?.message);
    } finally {
      setDeleteId(null);
    }
  };
  ...
  return (
    <div className="space-y-4">
      ...
      {deleteId !== null && (
        <SimpleDeleteDialog
          open={false} // luego cambiar a true para que funcione el dialog
