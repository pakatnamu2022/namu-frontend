...
import {
  FreightControlResource,
  FreightControlResponse,
  getFreightControlProps,
} from "./freightControl.interface";
...
export async function findFreightById(
  id: number,
): Promise<FreightControlResource> {
...
export async function updateFreight(
  id: number,
  data: any,
): Promise<FreightControlResponse> {
