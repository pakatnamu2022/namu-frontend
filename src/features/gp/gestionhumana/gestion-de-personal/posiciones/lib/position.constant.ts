...
export const POSITION_TYPE = {
  ...
  GENERAL_MANAGER: [23, 235, 255, 126],
  ...
  PDI: [132, 249],
  WAREHOUSE: [129, 248, 86],
  WAREHOUSE_ASSISTANT: [57, 87, 129, 233, 251, 309],
  POSVENTA_ASSISTANT: [90, 133],
  REPUESTOS: [344, 142],
  SECURITY_AGENT: [
  ...
  SPARE_PARTS_ADVISOR: [62, 72, 88, 130, 349],
};
