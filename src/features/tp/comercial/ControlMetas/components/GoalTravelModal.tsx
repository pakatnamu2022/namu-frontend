...
import { storeGoalTravel, updateGoalTravel } from "../lib/GoalTravelControl.actions";
...
export default function GoalTravelModal({
    ...
    function mapGoalTravelToFrom(data: GoalTravelControlResource ): Partial<GoalTravelSchema>{
        return {
            date: typeof data.date === 'string'
                ...
                : data.date instanceof Date
                    ...
                    :'',
            total: typeof data.total === 'string'
