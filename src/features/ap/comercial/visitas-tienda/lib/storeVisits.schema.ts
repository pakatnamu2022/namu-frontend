...
export const getStoreVisitsBaseObject = (requireAdvisor: boolean = true) =>
  z.object({
    ...
    worker_id: requireAdvisor
      ? requiredStringId("Asesor es requerido")
      : optionalStringId("Asesor es requerido"),
...
export const storeVisitsBaseObject = getStoreVisitsBaseObject(true);

export const getStoreVisitsSchemaCreate = (requireAdvisor: boolean = true) =>
  getStoreVisitsBaseObject(requireAdvisor).refine(
    (data) => {
...
export const getStoreVisitsSchemaUpdate = (requireAdvisor: boolean = true) =>
  getStoreVisitsBaseObject(requireAdvisor)
    .partial()
    .refine(
      (data) => {
...
export const storeVisitsSchemaCreate = getStoreVisitsSchemaCreate(true);
export const storeVisitsSchemaUpdate = getStoreVisitsSchemaUpdate(true);
