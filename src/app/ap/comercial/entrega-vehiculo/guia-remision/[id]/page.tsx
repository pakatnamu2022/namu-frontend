...
export default function ShippingGuidePage(): JSX.Element {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Checklist not confirmed warning */}
      {!checklistConfirmed && (
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-muted-foreground">Estado SUNAT</p>
                <Badge
                  color={
                    shippingGuide.aceptada_por_sunat ? "default" : "secondary"
                  }
                >
              ...
              <div>
                ...
                <Badge
                  color={
                    shippingGuide.is_sunat_registered ? "default" : "secondary"
                  }
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {shippingGuide.enlace_del_pdf && (
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          window.open(shippingGuide.enlace_del_pdf!, "_blank")
                        }
                      >
                    ...
                    {shippingGuide.enlace_del_xml && (
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          window.open(shippingGuide.enlace_del_xml!, "_blank")
                        }
                      >
                        <ExternalLink className="h-4 w-4 mr-2" />
                        Ver XML
                    ...
                    {shippingGuide.enlace_del_cdr && (
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          window.open(shippingGuide.enlace_del_cdr!, "_blank")
                        }
                      >
                        <ExternalLink className="h-4 w-4 mr-2" />
                        Ver CDR
