...
export interface ShippingGuidesResponse {
  data: ShippingGuidesResource[];
  links: Links;
  meta: Meta;
}

export interface ShippingGuidesResource {
  id: number;
...
export interface ShippingGuidesRequest {
  ap_vehicle_id: string;
  document_type: string;
  issuer_type: string;
  document_series_id?: string;
...
export interface getShippingGuidesProps {
