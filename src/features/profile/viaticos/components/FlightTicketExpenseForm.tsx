...
export default function FlightTicketExpenseForm({
  ...
  }, [expenseTypeId, flightTicketTypes, form]);
      ...
      >
        ...
        <div className="col-span-full space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <FormSelect
              ...
              label="Tipo de Boleto Aéreo"
              placeholder="Selecciona un tipo"
              options={expenseTypeOptions}
              control={form.control}
              description="Categoría del boleto aéreo"
              required
            />
          </div>
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-3 sm:gap-4 w-full sm:justify-end pt-4">
          ...
          >
            ...
            />
            {isSubmitting ? "Guardando..." : "Guardar Pasaje Aéreo"}
          </Button>
        </div>
      </form>
    </Form>
