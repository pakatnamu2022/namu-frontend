...
const colorTextMap: Record<TailwindColor, Record<ColorIntensity, string>> = {
  slate: { "50": "text-slate-900", "100": "text-slate-900", "200": "text-slate-900", "300": "text-slate-900", "400": "text-slate-900", "500": "text-slate-50", "600": "text-slate-50", "700": "text-slate-50", "800": "text-slate-50", "900": "text-slate-50", "950": "text-slate-50" },
  gray: { "50": "text-gray-900", "100": "text-gray-900", "200": "text-gray-900", "300": "text-gray-900", "400": "text-gray-900", "500": "text-gray-50", "600": "text-gray-50", "700": "text-gray-50", "800": "text-gray-50", "900": "text-gray-50", "950": "text-gray-50" },
  zinc: { "50": "text-zinc-900", "100": "text-zinc-900", "200": "text-zinc-900", "300": "text-zinc-900", "400": "text-zinc-900", "500": "text-zinc-50", "600": "text-zinc-50", "700": "text-zinc-50", "800": "text-zinc-50", "900": "text-zinc-50", "950": "text-zinc-50" },
  neutral: { "50": "text-neutral-900", "100": "text-neutral-900", "200": "text-neutral-900", "300": "text-neutral-900", "400": "text-neutral-900", "500": "text-neutral-50", "600": "text-neutral-50", "700": "text-neutral-50", "800": "text-neutral-50", "900": "text-neutral-50", "950": "text-neutral-50" },
  stone: { "50": "text-stone-900", "100": "text-stone-900", "200": "text-stone-900", "300": "text-stone-900", "400": "text-stone-900", "500": "text-stone-50", "600": "text-stone-50", "700": "text-stone-50", "800": "text-stone-50", "900": "text-stone-50", "950": "text-stone-50" },
  red: { "50": "text-red-900", "100": "text-red-900", "200": "text-red-900", "300": "text-red-900", "400": "text-red-900", "500": "text-red-50", "600": "text-red-50", "700": "text-red-50", "800": "text-red-50", "900": "text-red-50", "950": "text-red-50" },
  orange: { "50": "text-orange-900", "100": "text-orange-900", "200": "text-orange-900", "300": "text-orange-900", "400": "text-orange-900", "500": "text-orange-50", "600": "text-orange-50", "700": "text-orange-50", "800": "text-orange-50", "900": "text-orange-50", "950": "text-orange-50" },
  amber: { "50": "text-amber-900", "100": "text-amber-900", "200": "text-amber-900", "300": "text-amber-900", "400": "text-amber-900", "500": "text-amber-50", "600": "text-amber-50", "700": "text-amber-50", "800": "text-amber-50", "900": "text-amber-50", "950": "text-amber-50" },
  yellow: { "50": "text-yellow-900", "100": "text-yellow-900", "200": "text-yellow-900", "300": "text-yellow-900", "400": "text-yellow-900", "500": "text-yellow-900", "600": "text-yellow-50", "700": "text-yellow-50", "800": "text-yellow-50", "900": "text-yellow-50", "950": "text-yellow-50" },
  lime: { "50": "text-lime-900", "100": "text-lime-900", "200": "text-lime-900", "300": "text-lime-900", "400": "text-lime-900", "500": "text-lime-900", "600": "text-lime-50", "700": "text-lime-50", "800": "text-lime-50", "900": "text-lime-50", "950": "text-lime-50" },
  green: { "50": "text-green-900", "100": "text-green-900", "200": "text-green-900", "300": "text-green-900", "400": "text-green-900", "500": "text-green-50", "600": "text-green-50", "700": "text-green-50", "800": "text-green-50", "900": "text-green-50", "950": "text-green-50" },
  emerald: { "50": "text-emerald-900", "100": "text-emerald-900", "200": "text-emerald-900", "300": "text-emerald-900", "400": "text-emerald-900", "500": "text-emerald-50", "600": "text-emerald-50", "700": "text-emerald-50", "800": "text-emerald-50", "900": "text-emerald-50", "950": "text-emerald-50" },
  teal: { "50": "text-teal-900", "100": "text-teal-900", "200": "text-teal-900", "300": "text-teal-900", "400": "text-teal-900", "500": "text-teal-50", "600": "text-teal-50", "700": "text-teal-50", "800": "text-teal-50", "900": "text-teal-50", "950": "text-teal-50" },
  cyan: { "50": "text-cyan-900", "100": "text-cyan-900", "200": "text-cyan-900", "300": "text-cyan-900", "400": "text-cyan-900", "500": "text-cyan-900", "600": "text-cyan-50", "700": "text-cyan-50", "800": "text-cyan-50", "900": "text-cyan-50", "950": "text-cyan-50" },
  sky: { "50": "text-sky-900", "100": "text-sky-900", "200": "text-sky-900", "300": "text-sky-900", "400": "text-sky-900", "500": "text-sky-50", "600": "text-sky-50", "700": "text-sky-50", "800": "text-sky-50", "900": "text-sky-50", "950": "text-sky-50" },
  blue: { "50": "text-blue-900", "100": "text-blue-900", "200": "text-blue-900", "300": "text-blue-900", "400": "text-blue-900", "500": "text-blue-50", "600": "text-blue-50", "700": "text-blue-50", "800": "text-blue-50", "900": "text-blue-50", "950": "text-blue-50" },
  indigo: { "50": "text-indigo-900", "100": "text-indigo-900", "200": "text-indigo-900", "300": "text-indigo-900", "400": "text-indigo-900", "500": "text-indigo-50", "600": "text-indigo-50", "700": "text-indigo-50", "800": "text-indigo-50", "900": "text-indigo-50", "950": "text-indigo-50" },
  violet: { "50": "text-violet-900", "100": "text-violet-900", "200": "text-violet-900", "300": "text-violet-900", "400": "text-violet-900", "500": "text-violet-50", "600": "text-violet-50", "700": "text-violet-50", "800": "text-violet-50", "900": "text-violet-50", "950": "text-violet-50" },
  purple: { "50": "text-purple-900", "100": "text-purple-900", "200": "text-purple-900", "300": "text-purple-900", "400": "text-purple-900", "500": "text-purple-50", "600": "text-purple-50", "700": "text-purple-50", "800": "text-purple-50", "900": "text-purple-50", "950": "text-purple-50" },
  fuchsia: { "50": "text-fuchsia-900", "100": "text-fuchsia-900", "200": "text-fuchsia-900", "300": "text-fuchsia-900", "400": "text-fuchsia-900", "500": "text-fuchsia-50", "600": "text-fuchsia-50", "700": "text-fuchsia-50", "800": "text-fuchsia-50", "900": "text-fuchsia-50", "950": "text-fuchsia-50" },
  pink: { "50": "text-pink-900", "100": "text-pink-900", "200": "text-pink-900", "300": "text-pink-900", "400": "text-pink-900", "500": "text-pink-50", "600": "text-pink-50", "700": "text-pink-50", "800": "text-pink-50", "900": "text-pink-50", "950": "text-pink-50" },
  rose: { "50": "text-rose-900", "100": "text-rose-900", "200": "text-rose-900", "300": "text-rose-900", "400": "text-rose-900", "500": "text-rose-50", "600": "text-rose-50", "700": "text-rose-50", "800": "text-rose-50", "900": "text-rose-50", "950": "text-rose-50" },
};
...
export function MetricCard({
  ...
  const valueClass = variant === "default" ? colorTextMap[color][colorIntensity] : colorValueMap[color];

  return (
    <Card className={cn(
      "@container/card border-0 ",
      variant === "outline" && "bg-linear-to-br from-muted/50 via-muted/30 to-background",
      variant === "default" && bgClass,
      className
    )}>
      <CardHeader>
        <CardDescription className={cn("line-clamp-1", variant === "default" && textClass)}>
          {title}
        </CardDescription>
