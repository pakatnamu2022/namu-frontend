 ...
 *
 * Todas las importaciones usan lazy() para code splitting automático
 */
...
export const routeComponents: Record<string, RouteComponent> = {
  ...
  'gp/gestion-humana/administracion-de-personal/trabajadores': lazy(() => import('@/app/gp/gestion-humana/administracion-de-personal/trabajadores/page')),
