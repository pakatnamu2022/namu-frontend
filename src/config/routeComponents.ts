...
export const routeComponents: Record<string, RouteComponent> = {
  ...
  // 'gp/gestion-del-sistema/usuarios/actualizar': lazy(() => import('@/app/gp/gestion-del-sistema/usuarios/actualizar/page')),
  ...
  // 'gp/gestion-del-sistema/vistas/actualizar': lazy(() => import('@/app/gp/gestion-del-sistema/vistas/actualizar/page')),
  ...
  // 'gp/gestion-humana/configuraciones/posiciones/actualizar': lazy(() => import('@/app/gp/gestion-humana/configuraciones/posiciones/actualizar/page')),
  ...
  // 'gp/gestion-humana/evaluaciones-de-desempeno/categorias-jerarquicas/actualizar': lazy(() => import('@/app/gp/gestion-humana/evaluaciones-de-desempeno/categorias-jerarquicas/actualizar/page')),
  ...
  // 'gp/gestion-humana/evaluaciones-de-desempeno/ciclos/actualizar': lazy(() => import('@/app/gp/gestion-humana/evaluaciones-de-desempeno/ciclos/actualizar/page')),
  ...
  // 'gp/gestion-humana/evaluaciones-de-desempeno/competencias/actualizar': lazy(() => import('@/app/gp/gestion-humana/evaluaciones-de-desempeno/competencias/actualizar/page')),
  ...
  // 'gp/gestion-humana/evaluaciones-de-desempeno/evaluaciones/actualizar': lazy(() => import('@/app/gp/gestion-humana/evaluaciones-de-desempeno/evaluaciones/actualizar/page')),
  ...
  // 'gp/gestion-humana/evaluaciones-de-desempeno/metricas/actualizar': lazy(() => import('@/app/gp/gestion-humana/evaluaciones-de-desempeno/metricas/actualizar/page')),
  ...
  // 'gp/gestion-humana/evaluaciones-de-desempeno/objetivos/actualizar': lazy(() => import('@/app/gp/gestion-humana/evaluaciones-de-desempeno/objetivos/actualizar/page')),
  ...
  // 'gp/gestion-humana/evaluaciones-de-desempeno/parametros/actualizar': lazy(() => import('@/app/gp/gestion-humana/evaluaciones-de-desempeno/parametros/actualizar/page')),
  ...
  // 'gp/gestion-humana/evaluaciones-de-desempeno/periodos/actualizar': lazy(() => import('@/app/gp/gestion-humana/evaluaciones-de-desempeno/periodos/actualizar/page')),
  ...
  // 'gp/maestro-general/sede/actualizar': lazy(() => import('@/app/gp/maestro-general/sede/actualizar/page')),
  ...
  // 'gp/tics/equipos/actualizar': lazy(() => import('@/app/gp/tics/equipos/actualizar/page')),
  ...
  // 'ap/comercial/agenda/oportunidades/actualizar': lazy(() => import('@/app/ap/comercial/agenda/oportunidades/actualizar/page')),
  ...
  // 'ap/comercial/clientes/actualizar': lazy(() => import('@/app/ap/comercial/clientes/actualizar/page')),
  ...
  // 'ap/comercial/clientes/establecimientos/actualizar': lazy(() => import('@/app/ap/comercial/clientes/establecimientos/[id]/actualizar/page')),
  ...
  // 'ap/comercial/compra-vehiculo-nuevo/actualizar': lazy(() => import('@/app/ap/comercial/compra-vehiculo-nuevo/actualizar/page')),
  ...
  // 'ap/comercial/electronic-documents/actualizar': lazy(() => import('@/app/ap/comercial/electronic-documents/actualizar/page')),
  ...
  // 'ap/comercial/entrega-vehiculo/actualizar': lazy(() => import('@/app/ap/comercial/entrega-vehiculo/actualizar/page')),
  ...
  // 'ap/comercial/envios-recepciones/actualizar': lazy(() => import('@/app/ap/comercial/envios-recepciones/actualizar/page')),
  ...
  // 'ap/comercial/proveedores/actualizar': lazy(() => import('@/app/ap/comercial/proveedores/actualizar/page')),
  ...
  // 'ap/comercial/proveedores/establecimientos/actualizar': lazy(() => import('@/app/ap/comercial/proveedores/establecimientos/[id]/actualizar/page')),
  ...
  // 'ap/comercial/solicitudes-cotizaciones/actualizar': lazy(() => import('@/app/ap/comercial/solicitudes-cotizaciones/actualizar/page')),
  ...
  // 'ap/comercial/visitas-tienda/actualizar': lazy(() => import('@/app/ap/comercial/visitas-tienda/actualizar/page')),
  ...
  // 'ap/configuraciones/maestros-general/almacenes/actualizar': lazy(() => import('@/app/ap/configuraciones/maestros-general/almacenes/actualizar/page')),
  ...
  // 'ap/configuraciones/maestros-general/asignar-serie-usuario/actualizar': lazy(() => import('@/app/ap/configuraciones/maestros-general/asignar-serie-usuario/actualizar/page')),
  ...
  // 'ap/configuraciones/maestros-general/series': lazy(() => import('@/app/ap/configuraciones/maestros-general/series/page')),
  // 'ap/configuraciones/maestros-general/series/actualizar': lazy(() => import('@/app/ap/configuraciones/maestros-general/series/actualizar/page')),
  // 'ap/configuraciones/maestros-general/series/actualizar': lazy(() => import('@/app/ap/configuraciones/maestros-general/series/actualizar/[id]/page')),
  ...
  // 'ap/configuraciones/maestros-general/chequeras/actualizar': lazy(() => import('@/app/ap/configuraciones/maestros-general/chequeras/actualizar/page')),
  ...
  // 'ap/configuraciones/maestros-general/clase-articulo/actualizar': lazy(() => import('@/app/ap/configuraciones/maestros-general/clase-articulo/actualizar/page')),
  ...
  // 'ap/configuraciones/maestros-general/ubigeos/actualizar': lazy(() => import('@/app/ap/configuraciones/maestros-general/ubigeos/actualizar/page')),
  ...
  // 'ap/configuraciones/vehiculos/estados-vehiculo/actualizar': lazy(() => import('@/app/ap/configuraciones/vehiculos/estados-vehiculo/actualizar/page')),
  ...
  // 'ap/configuraciones/vehiculos/marcas/actualizar': lazy(() => import('@/app/ap/configuraciones/vehiculos/marcas/actualizar/page')),
  ...
  // 'ap/configuraciones/vehiculos/modelos-vn/actualizar': lazy(() => import('@/app/ap/configuraciones/vehiculos/modelos-vn/actualizar/page')),
