import {
  ...
  receptionChecklistSchemaCreate,
  receptionChecklistSchemaUpdate,
} from "../lib/receptionChecklist.schema";
...
interface ReceptionChecklistFormProps {
  defaultValues: Partial<ReceptionChecklistSchema>;
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full">
        ...
        <div className="flex gap-4 w-full justify-end">
          ...
          >
            ...
            />
            {isSubmitting ? "Guardando" : "Guardar Item de recepción"}
          </Button>
        </div>
      </form>
    </Form>
