...
export const viewSchemaCreate = z.object({
  descripcion: z
    .string()
    .max(255)
  ...
  company_id: requiredStringId("Selecciona una empresa"),
...
export const viewSchemaUpdate = viewSchemaCreate.partial();

export type ViewSchema = z.infer<typeof viewSchemaCreate>;
