...
import { useAssignBrandConsultant } from "@/src/features/ap/configuraciones/ventas/asignar-marca/lib/assignBrandConsultant.hook";
import HeaderTableWrapper from "@/src/shared/components/HeaderTableWrapper";
import AssignBrandConsultantOptions from "@/src/features/ap/configuraciones/ventas/asignar-marca/components/assignBrandConsultantOptions";
import { assignBrandConsultantColumns } from "@/src/features/ap/configuraciones/ventas/asignar-marca/components/assignBrandConsultantColumns";
import { updateAssignBrandConsultant } from "@/src/features/ap/configuraciones/ventas/asignar-marca/lib/assignBrandConsultant.actions";
import AssignBrandConsultantTable from "@/src/features/ap/configuraciones/ventas/asignar-marca/components/assignBrandConsultantTable";
import AssignBrandConsultantActions from "@/src/features/ap/configuraciones/ventas/asignar-marca/components/assignBrandConsultantActions";
