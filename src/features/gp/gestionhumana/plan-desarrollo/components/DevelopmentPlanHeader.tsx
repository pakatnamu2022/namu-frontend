          ...
          <div className="pt-1.5">
            <div className="flex flex-wrap gap-1.5">
                ...
                <div key={index} className="contents">
                  {item.objective_detail && (
                    <Badge
                      variant="outline"
                      icon={Target}
                      className="bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 text-xs py-0 h-6"
                    >
                  ...
                  {item.competence_detail && (
                    <Badge
                      variant="outline"
                      icon={Award}
                      className="bg-purple-50 dark:bg-purple-950/30 border-purple-200 dark:border-purple-800 text-purple-700 dark:text-purple-300 text-xs py-0 h-6"
                    >
              ...
              {plan.objectives_competences.length > 3 && (
                <Badge
                  variant="outline"
                  className="cursor-pointer hover:bg-muted/80 transition-colors text-xs py-0 h-6"
                  onClick={(e) => {
                    e.stopPropagation();
                    onToggleObjectivesCompetences();
                  }}
