...
} from "@/src/features/ap/comercial/ordenes-compra-vehiculo/lib/vehiclePurchaseOrder.actions";
import { VehiclePurchaseOrderSchema } from "@/src/features/ap/comercial/ordenes-compra-vehiculo/lib/vehiclePurchaseOrder.schema";
import { VehiclePurchaseOrderResource } from "@/src/features/ap/comercial/ordenes-compra-vehiculo/lib/vehiclePurchaseOrder.interface";
import { VehiclePurchaseOrderForm } from "@/src/features/ap/comercial/ordenes-compra-vehiculo/components/VehiclePurchaseOrderForm";
...
export default function ResendVehiclePurchaseOrderPage() {
  ...
  console.log(mapVehiclePurchaseOrderToForm(vehiclePurchaseOrder));
