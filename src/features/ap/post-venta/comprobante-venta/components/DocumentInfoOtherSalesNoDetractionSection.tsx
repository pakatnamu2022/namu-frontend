...
// Variante de DocumentInfoOtherSalesSection sin el switch de Detracción:
// esta operación nunca aplica detracción, por lo que el campo se omite del formulario
// y el plan de cuenta contable de los items no se filtra por detracción.
// Tampoco se muestra el switch de Tipo de Operación (IGV): siempre es Normal (con IGV).
export function DocumentInfoOtherSalesNoDetractionSection({
  form,
  isEdit,
  documentTypes,
  authorizedSeries,
