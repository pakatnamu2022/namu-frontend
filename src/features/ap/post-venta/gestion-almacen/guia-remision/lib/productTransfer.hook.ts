...
import { PRODUCT_TRANSFER } from "./productTransfer.constants.ts";
import {
...
} from "./productTransfer.actions.ts";
import {
  sendShippingGuideToNubefact,
  queryShippingGuideFromNubefact,
} from "@/features/ap/comercial/envios-recepciones/lib/shipmentsReceptions.actions.ts";
import { successToast, errorToast } from "@/core/core.function.ts";
