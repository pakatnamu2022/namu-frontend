...
export default function ReportesComercialPage() {
  return (
    <PageWrapper>
      <TitleComponent
        title={REPORTS_COMMERCIAL_CONSTANTS.MODEL.name}
        subtitle={SUBTITLE(REPORTS_COMMERCIAL_CONSTANTS.MODEL, "fetch")}
        icon={REPORTS_COMMERCIAL_CONSTANTS.ICON}
      />
