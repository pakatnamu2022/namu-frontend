...
interface AppointmentSelectionTableProps<TData, TValue> {
...
export function AppointmentSelectionTable<TData, TValue>({
  columns,
  data,
  children,
  isLoading = false,
  ...
  onRowClick,
}: AppointmentSelectionTableProps<TData, TValue>) {
          ...
          <Table className="text-sm">
            <TableHeader className="bg-muted/80 sticky top-0 z-10">
              {table.getHeaderGroups().map((headerGroup) => (
                <TableRow key={headerGroup.id} className="text-nowrap h-12 border-b">
