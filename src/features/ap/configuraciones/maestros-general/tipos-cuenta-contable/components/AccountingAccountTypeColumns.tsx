...
export type AccountingAccountTypeColumns =
  ColumnDef<AccountingAccountTypeResource>;
...
export const accountingAccountTypeColumns = ({
  onUpdate,
  onDelete,
  onToggleStatus,
  permissions,
}: Props): AccountingAccountTypeColumns[] => [
  {
