...
export type FuelTypeColumns = ColumnDef<FuelTypeResource>;
...
export const fuelTypeColumns = ({
  onUpdate,
  onDelete,
  onToggleStatus,
  permissions,
}: Props): FuelTypeColumns[] => [
  {
    accessorKey: "code",
    header: "Cod.",
    cell: ({ getValue }) => {
  ...
  {
    accessorKey: "electric_motor",
    header: "Motor Eléctrico",
    cell: ({ getValue }) => {
