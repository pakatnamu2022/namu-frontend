...
export const routeComponents: Record<string, RouteComponent> = {
  ...
  // 'ap/configuraciones/maestros-general/asignar-serie-venta/actualizar': lazy(() => import('@/app/ap/configuraciones/maestros-general/asignar-serie-venta/actualizar/page')),
