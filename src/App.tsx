...
const ProductivityTechnicianDetailPageRoute = lazyPage(() => import("./app/ap/post-venta/indicadores-y-reportes/dashboard-productividad/tecnico/[workerId]/page.tsx"));
