...
export const CONSTANTS: any = {
  ...
  LOGO: "/logos/sian_complete.svg",
  LOGO_WHITE: "/logos/sian_complete_white.svg",
  LOGO_ICON: "/logos/sian_logo.svg",
...
export const BUSINESS_PARTNERS = {
  ...
  TYPE_DOCUMENT_CE_ID: "811",
  PERSON_SEGMENT_DEFAULT_ID: "823",
  TYPE_TAX_CLASS_DEFAULT_ID: "4",
  ACTIVITY_ECONOMIC_DEFAULT_ID: "793",
  RUC_PREFIX_NATURAL: "10",
  RUC_PREFIX_EXTRANJERO: "15",
  RUC_PREFIX_JURIDICA: "20",
};
...
export const VALIDATABLE_DOCUMENT = {
  IDS: [
    ...
    BUSINESS_PARTNERS.TYPE_DOCUMENT_CE_ID, // Si tienes este ID
  ],
  TYPE_MAP: {
    [BUSINESS_PARTNERS.TYPE_DOCUMENT_DNI_ID]: "dni",
    [BUSINESS_PARTNERS.TYPE_DOCUMENT_RUC_ID]: "ruc",
    [BUSINESS_PARTNERS.TYPE_DOCUMENT_CE_ID]: "ce",
  },
};
