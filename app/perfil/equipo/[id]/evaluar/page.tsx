...
import { TrendingUp, Target, Calendar, RefreshCw, ChevronLeft } from "lucide-react";
...
import { useActivePerformanceEvaluation } from "@/src/features/gp/gestionhumana/evaluaciondesempeño/dashboard/lib/performance-evaluation.hook";
import {
...
import { EVALUATION_OBJECTIVE } from "@/src/features/gp/gestionhumana/evaluaciondesempeño/evaluaciones/lib/evaluation.constans";
...
export default function EvaluarPage() {
  ...
  const {
    ...
    queryFn: () =>
      import(
        "@/src/features/gp/gestionhumana/evaluaciondesempeño/evaluation-person/lib/evaluationPerson.actions"
      ).then((m) =>
  ...
  const handleBack = () => {
    ...
    router.push(`/perfil/equipo${queryString ? `?${queryString}` : ''}`);
  };
          ...
          <CardContent className="mx-auto max-w-7xl">
            <CardHeader className="space-y-4 p-0">
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-2xl">No hay evaluación activa</CardTitle>
                  <CardDescription>
                    No se encontró una evaluación activa para evaluar en este momento.
                  </CardDescription>
                </div>
                <Button
                  variant="outline"
            ...
            <div className="flex items-center justify-between pt-4 border-t">
              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    {new Date(
                      activeEvaluation.start_date
                    ).toLocaleDateString("es-ES")}{" "}
                    -
                    {new Date(
                      activeEvaluation.end_date
                    ).toLocaleDateString("es-ES")}
                  </span>
                </div>
