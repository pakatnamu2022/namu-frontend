...
import { OpportunityActionForm } from "@/src/features/ap/comercial/oportunidades/components/OpportunityActionForm";
import {
...
import { useCustomerValidated } from "@/src/features/ap/comercial/clientes/lib/customers.hook";
import FormSkeleton from "@/src/shared/components/FormSkeleton";
import { ERROR_MESSAGE, errorToast } from "@/src/core/core.function";
...
import { LeadInfoCard } from "@/src/features/ap/comercial/oportunidades/components/LeadInfoCard";
import { useManageLead } from "@/src/features/ap/comercial/gestionar-leads/lib/manageLeads.hook";
...
export default function AddOpportunityPage() {
  ...
  const handleActionSubmit = (data: any) => {
    ...
    createActionMutation.mutate(
      ...
      {
        onSuccess: () => {
          router.push(`${ABSOLUTE_ROUTE}/${createdOpportunityId}`);
        },
      }
    );
  };
